import {digitos, signos, numeros} from './data/lenguage';
import { vocabularyInterface } from './interfaces/interfaces';


const vocabulary: vocabularyInterface[]= [ {digitos, signos, numeros} ];

const digitosLetra = [...vocabulary[0].digitos, ...vocabulary[0].numeros];
             
const runAutomata = (input: string) => {
    let state = 0;
    let variableName = '';
